...
var StatsController = /** @class */ (function () {
    ...
    StatsController.prototype.getStats = function () {
        return __awaiter(this, void 0, void 0, function () {
            var allPurchases, purchaseCount, moneyInDeelNow, salesCount, profit, allSpentMoney, userProfit, growPercent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_connector_1.dbConnector.purchases.find().toArray()
                    ...
                    case 1:
                        ...
                        allPurchases.forEach(function (p) {
                            var _a = stats_service_1.statsService.getStats(p), purchaseCountElement = _a.purchaseCount, moneyInDeelNowElement = _a.moneyInDeelNow, salesCountElement = _a.salesCount, profitElement = _a.profit, userProfitElement = _a.userProfit, allSpentMoneyElement = _a.allSpentMoney;
